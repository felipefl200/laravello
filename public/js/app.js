  ...
  methods: {
    addCard: function addCard() {
      this.$apollo.mutate({
        ...
        variables: {
          title: 'Adicionado pela mutation',
          listId: 2,
          order: 1
        },
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "bg-white rounded-sm cursor-pointer text-sm shadow-sm hover:bg-gray-100 mb-2 p-1"
    },
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "rounded-sm p-2 text-gray-600 hover:text-gray-800 hover:bg-gray-400 cursor-pointer text-sm",
